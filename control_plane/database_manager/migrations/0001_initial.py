# Generated by Django 4.1.2 on 2022-11-17 01:03
...
import database_manager.types.database_state_types
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('resource_manager', '0003_alter_resource_collected_at'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[(database_manager.types.database_state_types.DatabaseStateType['REGISTERING'], 'REGISTERING'), (database_manager.types.database_state_types.DatabaseStateType['HEALTHY'], 'HEALTHY'), (database_manager.types.database_state_types.DatabaseStateType['UNHEALTHY'], 'UNHEALTHY'), (database_manager.types.database_state_types.DatabaseStateType['TUNING'], 'TUNING'), (database_manager.types.database_state_types.DatabaseStateType['COLLECTING_WORKLOAD'], 'COLLECTING_WORKLOAD'), (database_manager.types.database_state_types.DatabaseStateType['COLLECTING_METRICS'], 'COLLECTING_METRICS'), (database_manager.types.database_state_types.DatabaseStateType['COLLECTING_STATE'], 'COLLECTING_STATE')], max_length=120)),
