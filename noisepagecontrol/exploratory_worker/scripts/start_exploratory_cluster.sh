...
#       $ sudo -u postgres scripts/start_exploratory_cluster_snapshot.sh port [-s]
###############################################################################
...
if [[ -z $port ]]
then
    echo "Missing port. Command: sudo -u postgres scripts/start_exploratory_cluster_snapshot.sh port [-s]"
    exit
fi
